...
gcc -Wall -g -Wno-unused-function syntax.tab.c lex.yy.c \
  build/main.o build/utils.o build/three_address_code.o build/assembly_code.o build/ast.o build/symbols.o build/ast_modules.o build/tac_modules.o build/semantic_check.o \
  -o build/c-tds -lfl
