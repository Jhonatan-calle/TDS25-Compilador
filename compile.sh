...
gcc -Wall -g -c src/tac_modules.c -o build/tac_modules.o
gcc -Wall -g -c src/three_address_code.c -o build/three_address_code.o
gcc -Wall -g -c src/assembly_modules.c -o build/assembly_modules.o
...
gcc -Wall -g -Wno-unused-function syntax.tab.c lex.yy.c \
  build/main.o build/utils.o build/three_address_code.o build/assembly_modules.o build/assembly_code.o build/ast.o build/symbols.o build/ast_modules.o build/tac_modules.o build/semantic_check.o \
  -o build/c-tds -lfl
