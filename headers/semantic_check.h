...
void exit_if_types_invalid_at_declaration(AST *exp, Types type_identifier, char *name);
void exit_if_invalid_return_type(AST *sentence, int type_identifier,
                                 char *name, int i);
...
void exit_if_operators_mismatch_types(AST *first_operand, AST *second_operand, char *op);
